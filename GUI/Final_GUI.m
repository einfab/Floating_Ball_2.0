function ball_motor_gui(arduino)
    ...
    uicontrol('Style', 'text', 'Position', [10, 170, 50, 20], 'String', 'P:', ...
              'HorizontalAlignment', 'right', 'FontSize', 10);
    inputP = uicontrol('Style', 'edit', 'Position', [70, 170, 100, 20], 'String', '1.0', ...
                       'Callback', @updatePID);
    uicontrol('Style', 'text', 'Position', [10, 140, 50, 20], 'String', 'I:', ...
              'HorizontalAlignment', 'right', 'FontSize', 10);
    inputI = uicontrol('Style', 'edit', 'Position', [70, 140, 100, 20], 'String', '0.5', ...
                       'Callback', @updatePID);
    uicontrol('Style', 'text', 'Position', [10, 110, 50, 20], 'String', 'D:', ...
              'HorizontalAlignment', 'right', 'FontSize', 10);
    ...
    handles.saveButton = uicontrol('Style', 'pushbutton', 'String', 'Save', ...
                                   'Position', [200, 70, 100, 40], 'Callback', @saveData);
